...
export const products = mysqlTable(
  "products",
  {
    ...
    lastMetaCatalogChangeAt: timestamp("lastMetaCatalogChangeAt"),
    lastMetaCatalogChangeType: varchar("lastMetaCatalogChangeType", { length: 40 }),
    lastMetaCatalogChangeInternal: boolean("lastMetaCatalogChangeInternal").default(false).notNull(),
    metaCatalogSyncIgnoredAt: timestamp("metaCatalogSyncIgnoredAt"),
  },
  table => [
...
export const metaCatalogAutoSyncQueue = mysqlTable(
  "meta_catalog_auto_sync_queue",
  {
    ...
    status: mysqlEnum("status", ["pending", "processing", "completed", "failed", "ignored"]).default("pending").notNull(),
...
export const customerProfiles = mysqlTable(
  "customer_profiles",
  {
    ...
    socialUsername: varchar("socialUsername", { length: 160 }),
    externalProfileId: varchar("externalProfileId", { length: 255 }),
    profileMetadataJson: text("profileMetadataJson"),
...
export const inboxConversations = mysqlTable(
  "inbox_conversations",
  {
    ...
    nativeThreadUrl: varchar("nativeThreadUrl", { length: 2048 }),
    contactNameSnapshot: varchar("contactNameSnapshot", { length: 160 }),
    contactPhoneSnapshot: varchar("contactPhoneSnapshot", { length: 40 }),
    contactAvatarUrl: varchar("contactAvatarUrl", { length: 2048 }),
    contactUsername: varchar("contactUsername", { length: 160 }),
    contactProfileJson: text("contactProfileJson"),
...
export const metaConnections = mysqlTable(
  "meta_connections",
  {
    ...
    encryptedSystemUserToken: text("encryptedSystemUserToken"),
    systemUserTokenStatus: mysqlEnum("systemUserTokenStatus", ["missing", "ready", "invalid", "revoked"]).default("missing").notNull(),
    systemUserTokenLastTestedAt: timestamp("systemUserTokenLastTestedAt"),
...
export const customerBotSettings = mysqlTable(
  "customer_bot_settings",
  {
    ...
    messengerEnabled: boolean("messengerEnabled").default(false).notNull(),
    instagramEnabled: boolean("instagramEnabled").default(false).notNull(),
...
export const customerBotRuns = mysqlTable(
  "customer_bot_runs",
  {
    ...
    status: mysqlEnum("status", ["draft", "handoff", "failed", "dismissed", "replied"]).notNull(),
    model: varchar("model", { length: 80 }),
    confidence: int("confidence"),
