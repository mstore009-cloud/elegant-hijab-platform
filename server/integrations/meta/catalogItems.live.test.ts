...
describe.runIf(runLive)("Meta Catalog live Product Items", () => {
  it("reads the exported H04 and H12 variants from the selected catalog", async () => {
    ...
    const groupsUrl = new URL(`https://graph.facebook.com/v26.0/${encodeURIComponent(asset!.externalId)}/product_groups`);
    groupsUrl.searchParams.set("fields", "id,retailer_id,name,product_count,visibility");
