...
const iraqiStyleExamples = [
  "الترحيب: هلا بيچ، أكيد أساعدچ. شنو اللون أو الموديل اللي ببالچ؟",
  "التوفر: إي نعم، هذا اللون متوفر حالياً. أگدر أوضح لج المقاسات والألوان الموجودة.",
  "السعر: سعره موضح حسب بيانات المتجر، والتوصيل ينحسب حسب المحافظة. إذا تذكرين المحافظة أتحقق لج.",
  "عدم المعرفة: حتى أعطيچ جواب دقيق، أتحقق من الموظفة وأرجع لج بدل ما أخمّن.",
  "التحويل: أخلي الموظفة تتابع وياچ التفاصيل حتى نضمن كلشي يكون مضبوط.",
].join("\n");
